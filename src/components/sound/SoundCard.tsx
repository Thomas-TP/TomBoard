    ...
    >
      ...
      >
        ...
        <IconButton
          ...
          aria-label={
            sound.isFavorite
              ? `${t("removeFromFavorites")} ${sound.name}`
              : `${t("addToFavorites")} ${sound.name}`
          }
          onClick={(e) => {
            e.stopPropagation();
          ...
          >
            ...
            >
              {isPlaying ? (
                ...
                <Typography sx={{ fontSize: compact ? "0.85rem" : "1.4rem", lineHeight: 1 }}>
                  {sound.icon}
                </Typography>
              )}
            </Box>
        ...
        {!compact && (
          ...
          >
            ...
            <Typography
              variant="caption"
              sx={{ minWidth: 24, fontSize: "0.6rem", color: "text.secondary", fontWeight: 600 }}
            >
