  ...
  return (
    ...
    >
      ...
      <MenuItem
        ...
        sx={{ borderRadius: "8px", mx: 0.5, fontSize: "0.82rem" }}
      >
        <ListItemIcon>
      ...
      >
        ...
        <ListItemText>
          {sound.isFavorite ? t("removeFromFavorites") : t("addToFavorites")}
        </ListItemText>
      </MenuItem>
      ...
      >
        <ListItemIcon>
          <Delete sx={{ fontSize: 17, color: "inherit" }} />
        </ListItemIcon>
